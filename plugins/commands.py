...
main_buttons = [[
        InlineKeyboardButton('Main Channel', url='https://t.me/Interworldmx')
        ],[
        InlineKeyboardButton('📜 sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ ', url='https://t.me/InterWorld_Request'),
        InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ  ', url='https://t.me/Interworldmx')
        ],[
